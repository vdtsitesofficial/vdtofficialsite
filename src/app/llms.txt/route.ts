...
function build(): string {
  ...
  const lines: string[] = [
    ...
    "",
    "VDT Sites builds custom websites rather than assembling templates. Most small business sites are ready in one to three weeks. Clients can edit their own text and images directly on the live page, and the code is theirs on request once the project is paid in full.",
    "",
